...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_ODConv,
                     CSPStage, VoVGSCSP, VoVGSCSPns, VoVGSCSPC, C2f_DySnakeConv, C2f_DAttention, C2f_DLKA,
                     C2f_DynamicConv, C2f_EMBC, C2f_EMSC, C2f_EMSCP, C2f_Faster, C2f_GhostDynamicConv,
                     C2f_SCConv, C2f_ScConv, C2f_DWR, C2f_MSBlock, C2f_ContextGuided, C2f_DBB, C2f_DRB,
                     C2f_iRMB, C2f_OREPA, C2f_PKIModule, C2f_PPA, C2f_REPVGGOREPA, C2f_RetBlock, C2f_RVB,
                     C2f_Star, C2f_SWC, C2f_UniRepLKNetBlock, C2f_Faster_CGLU, C2f_Faster_EMA, C2f_Star_CAA,
                     C2f_DCNv2_Dynamic, C2f_DCNv2, C2f_DWR_DRB, C2f_KAN, C2f_EIEM}:
            ...
            args = [ch[f], c2, *args]
                   ...
                   TripletAttention, CoordAtt, LSKBlock,
                   SEAttention, CPCA, MPCA, deformable_LKA,
                   EffectiveSEModule, LSKA, SegNext_Attention, DAttention, MLCA,
                   FocusedLinearAttention, LocalWindowAttention, ChannelAttention_HSFPN,
                   DySample, CAA, ELA, CAFM, ScConv, ELA_HSFPN, CA_HSFPN, CAA_HSFPN, GAM
                   }:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
